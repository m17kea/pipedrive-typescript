...
export class AddActivityRequestAllOf {
    /**
    ...
    */
    'busyFlag'?: AddActivityRequestAllOf.BusyFlagEnum;
    /**
    ...
    */
    ...
    'done'?: AddActivityRequestAllOf.DoneEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "busyFlag",
            "baseName": "busy_flag",
            "type": "AddActivityRequestAllOf.BusyFlagEnum"
        },
        {
            "name": "attendees",
            "baseName": "attendees",
        ...
        },
        {
            "name": "done",
            "baseName": "done",
            "type": "AddActivityRequestAllOf.DoneEnum"
        }    ];

    static getAttributeTypeMap() {
        return AddActivityRequestAllOf.attributeTypeMap;
    }
}

export namespace AddActivityRequestAllOf {
