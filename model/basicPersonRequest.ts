...
export class BasicPersonRequest {
    /**
    ...
    */
    ...
    'visibleTo'?: BasicPersonRequest.VisibleToEnum;
    'marketingStatus'?: BasicPersonRequest.MarketingStatusEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "visibleTo",
            "baseName": "visible_to",
            "type": "BasicPersonRequest.VisibleToEnum"
        },
        {
            "name": "marketingStatus",
            "baseName": "marketing_status",
            "type": "BasicPersonRequest.MarketingStatusEnum"
        },
        {
            "name": "addTime",
            "baseName": "add_time",
    ...
    static getAttributeTypeMap() {
        return BasicPersonRequest.attributeTypeMap;
    }
}

export namespace BasicPersonRequest {
