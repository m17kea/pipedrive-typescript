...
export class UpdateDealRequest {
    ...
    */
    'lostReason'?: string;
    'visibleTo'?: UpdateDealRequest.VisibleToEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "UpdateDealRequest.StatusEnum"
        },
        {
        ...
        },
        {
            "name": "visibleTo",
            "baseName": "visible_to",
            "type": "UpdateDealRequest.VisibleToEnum"
        }    ];

    static getAttributeTypeMap() {
        return UpdateDealRequest.attributeTypeMap;
    }
}
