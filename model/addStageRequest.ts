...
export class AddStageRequest {
    ...
    */
    'rottenFlag'?: AddStageRequest.RottenFlagEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "AddStageRequest.RottenFlagEnum"
        },
        {
            "name": "rottenDays",
    ...
    static getAttributeTypeMap() {
        return AddStageRequest.attributeTypeMap;
    }
}

export namespace AddStageRequest {
