...
/**
 * Check if a given object implements the GetAssociatedFilesResponse200AllOf interface.
 */
export function instanceOfGetAssociatedFilesResponse200AllOf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GetAssociatedFilesResponse200AllOfFromJSON(json: any): GetAssociatedFilesResponse200AllOf {
    return GetAssociatedFilesResponse200AllOfFromJSONTyped(json, false);
}

export function GetAssociatedFilesResponse200AllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAssociatedFilesResponse200AllOf {
...
export function GetAssociatedFilesResponse200AllOfToJSON(value?: GetAssociatedFilesResponse200AllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
