...
export interface GetProductAttachementResponse200Data {
     ...
     * @memberof GetProductAttachementResponse200Data
     */
    enabled_flag?: GetProductAttachementResponse200DataEnabledFlagEnum;
    /**
...
* @enum {string}
*/
export enum GetProductAttachementResponse200DataEnabledFlagEnum {
    NUMBER_0 = 0,
    NUMBER_1 = 1
}
...
/**
 * Check if a given object implements the GetProductAttachementResponse200Data interface.
 */
export function instanceOfGetProductAttachementResponse200Data(value: object): boolean {
    let isInstance = true;
...
export function GetProductAttachementResponse200DataFromJSON(json: any): GetProductAttachementResponse200Data {
    return GetProductAttachementResponse200DataFromJSONTyped(json, false);
}

export function GetProductAttachementResponse200DataFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetProductAttachementResponse200Data {
...
export function GetProductAttachementResponse200DataToJSON(value?: GetProductAttachementResponse200Data | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
