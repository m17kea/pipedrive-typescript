...
/**
 * Check if a given object implements the BaseOrganizationItem interface.
 */
export function instanceOfBaseOrganizationItem(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BaseOrganizationItemFromJSON(json: any): BaseOrganizationItem {
    return BaseOrganizationItemFromJSONTyped(json, false);
}

export function BaseOrganizationItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseOrganizationItem {
...
export function BaseOrganizationItemToJSON(value?: BaseOrganizationItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
