...
export interface GetProductFieldResponse200Data {
     ...
     * @memberof GetProductFieldResponse200Data
     */
    field_type: GetProductFieldResponse200DataFieldTypeEnum;
    /**
...
* @enum {string}
*/
export enum GetProductFieldResponse200DataFieldTypeEnum {
    Varchar = 'varchar',
...
/**
 * Check if a given object implements the GetProductFieldResponse200Data interface.
 */
export function instanceOfGetProductFieldResponse200Data(value: object): boolean {
    let isInstance = true;
...
export function GetProductFieldResponse200DataFromJSON(json: any): GetProductFieldResponse200Data {
    return GetProductFieldResponse200DataFromJSONTyped(json, false);
}

export function GetProductFieldResponse200DataFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetProductFieldResponse200Data {
...
export function GetProductFieldResponse200DataToJSON(value?: GetProductFieldResponse200Data | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
