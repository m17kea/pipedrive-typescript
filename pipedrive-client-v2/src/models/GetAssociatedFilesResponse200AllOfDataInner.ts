...
/**
 * Check if a given object implements the GetAssociatedFilesResponse200AllOfDataInner interface.
 */
export function instanceOfGetAssociatedFilesResponse200AllOfDataInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GetAssociatedFilesResponse200AllOfDataInnerFromJSON(json: any): GetAssociatedFilesResponse200AllOfDataInner {
    return GetAssociatedFilesResponse200AllOfDataInnerFromJSONTyped(json, false);
}

export function GetAssociatedFilesResponse200AllOfDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAssociatedFilesResponse200AllOfDataInner {
...
export function GetAssociatedFilesResponse200AllOfDataInnerToJSON(value?: GetAssociatedFilesResponse200AllOfDataInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
