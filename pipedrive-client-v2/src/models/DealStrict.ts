...
/**
 * Check if a given object implements the DealStrict interface.
 */
export function instanceOfDealStrict(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DealStrictFromJSON(json: any): DealStrict {
    return DealStrictFromJSONTyped(json, false);
}

export function DealStrictFromJSONTyped(json: any, ignoreDiscriminator: boolean): DealStrict {
...
export function DealStrictToJSON(value?: DealStrict | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
