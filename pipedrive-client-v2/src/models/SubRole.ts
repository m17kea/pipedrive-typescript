...
/**
 * Check if a given object implements the SubRole interface.
 */
export function instanceOfSubRole(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SubRoleFromJSON(json: any): SubRole {
    return SubRoleFromJSONTyped(json, false);
}

export function SubRoleFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubRole {
...
export function SubRoleToJSON(value?: SubRole | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
