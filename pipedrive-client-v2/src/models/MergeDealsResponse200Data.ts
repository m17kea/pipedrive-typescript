...
/**
 * Check if a given object implements the MergeDealsResponse200Data interface.
 */
export function instanceOfMergeDealsResponse200Data(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MergeDealsResponse200DataFromJSON(json: any): MergeDealsResponse200Data {
    return MergeDealsResponse200DataFromJSONTyped(json, false);
}

export function MergeDealsResponse200DataFromJSONTyped(json: any, ignoreDiscriminator: boolean): MergeDealsResponse200Data {
...
export function MergeDealsResponse200DataToJSON(value?: MergeDealsResponse200Data | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
