...
/**
 * Check if a given object implements the BasePipelineWithSelectedFlagAllOf interface.
 */
export function instanceOfBasePipelineWithSelectedFlagAllOf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BasePipelineWithSelectedFlagAllOfFromJSON(json: any): BasePipelineWithSelectedFlagAllOf {
    return BasePipelineWithSelectedFlagAllOfFromJSONTyped(json, false);
}

export function BasePipelineWithSelectedFlagAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BasePipelineWithSelectedFlagAllOf {
...
export function BasePipelineWithSelectedFlagAllOfToJSON(value?: BasePipelineWithSelectedFlagAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
