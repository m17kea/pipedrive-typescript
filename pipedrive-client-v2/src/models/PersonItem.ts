...
/**
 * Check if a given object implements the PersonItem interface.
 */
export function instanceOfPersonItem(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PersonItemFromJSON(json: any): PersonItem {
    return PersonItemFromJSONTyped(json, false);
}

export function PersonItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonItem {
...
export function PersonItemToJSON(value?: PersonItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
