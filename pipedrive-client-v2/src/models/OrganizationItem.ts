...
/**
 * Check if a given object implements the OrganizationItem interface.
 */
export function instanceOfOrganizationItem(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OrganizationItemFromJSON(json: any): OrganizationItem {
    return OrganizationItemFromJSONTyped(json, false);
}

export function OrganizationItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrganizationItem {
...
export function OrganizationItemToJSON(value?: OrganizationItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
