 ...
 * The deal object
 * @export
 * @interface DuplicateDealResponse200Data
 */
export interface DuplicateDealResponse200Data {
    /**
     * The ID of the deal
     * @type {number}
     * @memberof DuplicateDealResponse200Data
     */
    id?: number;
    /**
...
/**
 * Check if a given object implements the DuplicateDealResponse200Data interface.
 */
export function instanceOfDuplicateDealResponse200Data(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DuplicateDealResponse200DataFromJSON(json: any): DuplicateDealResponse200Data {
    return DuplicateDealResponse200DataFromJSONTyped(json, false);
}

export function DuplicateDealResponse200DataFromJSONTyped(json: any, ignoreDiscriminator: boolean): DuplicateDealResponse200Data {
...
export function DuplicateDealResponse200DataToJSON(value?: DuplicateDealResponse200Data | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
