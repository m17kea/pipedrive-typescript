...
/**
 * Check if a given object implements the PipelineDetails interface.
 */
export function instanceOfPipelineDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PipelineDetailsFromJSON(json: any): PipelineDetails {
    return PipelineDetailsFromJSONTyped(json, false);
}

export function PipelineDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PipelineDetails {
...
export function PipelineDetailsToJSON(value?: PipelineDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
