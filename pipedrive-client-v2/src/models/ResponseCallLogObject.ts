...
export interface ResponseCallLogObject {
     ...
     * @memberof ResponseCallLogObject
     */
    outcome: ResponseCallLogObjectOutcomeEnum;
    /**
...
* @enum {string}
*/
export enum ResponseCallLogObjectOutcomeEnum {
    Connected = 'connected',
    NoAnswer = 'no_answer',
...
/**
 * Check if a given object implements the ResponseCallLogObject interface.
 */
export function instanceOfResponseCallLogObject(value: object): boolean {
    let isInstance = true;
...
export function ResponseCallLogObjectFromJSON(json: any): ResponseCallLogObject {
    return ResponseCallLogObjectFromJSONTyped(json, false);
}

export function ResponseCallLogObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseCallLogObject {
...
export function ResponseCallLogObjectToJSON(value?: ResponseCallLogObject | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
